...
**This file is canon; the Figma frame `1386:139` (rev 2) is a generated view.** Shared vocabulary: [[README|registers README]].
...
Evidence status (D-107): 11 of the 22 are evidenced — a recorded incident or corpus-coded finding has landed on the row — and 11 are candidates, enumerated in advance and still waiting for their receipt.
